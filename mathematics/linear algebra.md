...
$$
v_1, v_2, ..., v_n \in R^n일 때,\\
c_1v_1+...+c_nv_n을 \;선형결합이라고\; 한다.\\
(c_1,...,c_n\in R)
$$
...
- **선형종속 (Linearly dependent)**
  ...
  **!!! 3차원 공간에서 4개의 벡터가 주어지면 무조건 선형종속이 될 수밖에 없다 !!!**
  ...
  ![image-20220127224231316](../../../../AppData/Roaming/Typora/typora-user-images/image-20220127224231316.png)
...
- **선형종속과 선형독립 구분방법**
  $$
  c_1v_1 + ... +c_nv=0이고,\; c_1,...,c_n\; 중\; 하나라도\; 0이\; 아니면\; 선형종속이다. \\
  증명) 만약\; c_1=0이\;아닌\; 실수라고\; 하면\; 양변을\; c1으로\; 나눌\; 수\; 있다. \\
  v_1+\frac{c_2v_2}{c_1}+...+\frac{c_nv_n}{c_n}=0\\
  \frac{c_2v_2}{c_1}+...+\frac{c_nv_n}{c_n}=-v_1\\
  -\frac{c_2v_2}{c_1}+...-\frac{c_nv_n}{c_n}=v_1\\
  즉,\; 하나의\; 벡터를\; 다른\; 벡터들의\; 선형결합으로\; 표현되므로\; 선형종속이다.
  $$
